...
\hypersetup{
  pdftitle={History of the Islamicate World: 570-1500   تاريخ الإسلام \textbar{} תאריֹךֹ אלאסלאם},
...
\title{History of the Islamicate World: 570-1500 تاريخ الإسلام \textbar{} תאריֹךֹ אלאסלאם}
...
\hypertarget{the-ux2bfabbux101sids-an-islamic-empire}{%
\chapter{The ʿAbbāsids: an Islamic empire}\label{the-ux2bfabbux101sids-an-islamic-empire}}
...
\hypertarget{medieval-muslim-education-arabic-books-and-the-formation-of-the-islamic-world}{%
\chapter{Medieval Muslim Education, Arabic Books, and the Formation of the Islamic World}\label{medieval-muslim-education-arabic-books-and-the-formation-of-the-islamic-world}}
...
\addcontentsline{toc}{section}{From conquest to Islamisation and Arabisation}
...
\caption{Image credit: Al-Turayya Project by Romanov and Seydi. See Resources below}
\end{figure}

\hypertarget{the-centrality-of-the-quran}{%
\section*{The Centrality of the Quran}\label{the-centrality-of-the-quran}}
\addcontentsline{toc}{section}{The Centrality of the Quran}

\begin{figure}

\includegraphics[width=0.5\linewidth]{https://upload.wikimedia.org/wikipedia/commons/3/37/Iqra} \hfill{}

\caption{Quran: 96:1-5, Wikimedia Commons.}\label{fig:unnamed-chunk-1}
\end{figure}
...
\hypertarget{medieval-muslimss-view-on-teaching-the-quran-to-their-children}{%
\section*{Medieval Muslims's view on teaching the Quran to their children}\label{medieval-muslimss-view-on-teaching-the-quran-to-their-children}}
\addcontentsline{toc}{section}{Medieval Muslims's view on teaching the Quran to their children}
...
\hypertarget{hadith.-transmission-of-prophetic-traditions}{%
\section*{Hadith. Transmission of Prophetic traditions}\label{hadith.-transmission-of-prophetic-traditions}}
\addcontentsline{toc}{section}{Hadith. Transmission of Prophetic traditions}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{./files/transmission.png}
\caption{Some key terms: ḥadīth - tradition,riwāya - transmission or narration, isnād/sanad - chain of authorities samāʾ - audition,ijāza - permission}
\end{figure}

\includegraphics{./files/hadith.png}
\_\_\_

\begin{figure}
\centering
\includegraphics{./files/rectangularmap.jpeg}
\caption{11th century `first rectangular map of the world, from the \emph{Book of Curosities} (see Reseources)'}
\end{figure}

\hypertarget{excercise-1.-how-long-did-it-take-to-get-to-mecca-from-kabul-cordova-or-samarqand}{%
\section*{Excercise 1. How long did it take to get to Mecca from Kabul, Cordova or Samarqand?}\label{excercise-1.-how-long-did-it-take-to-get-to-mecca-from-kabul-cordova-or-samarqand}}
\addcontentsline{toc}{section}{Excercise 1. How long did it take to get to Mecca from Kabul, Cordova or Samarqand?}

\begin{quote}
In modern days, the journey from Kabul to Mecca could take about 7hrs, (Kabul-Jeddah flight takes 5.30h, Jeddah-Mecca drive take 1 hour. Using the \textbf{Path Finding} tool on Althurayya Website below, can you find the \textbf{shortest} and \textbf{most optimal} medieval route to travel from Kabul to Mecca. Would you chose a different route if you were a tenth-century pilgrim from Central Asia? How do you think modern means of communication and transportation may influence our views about the past?
\end{quote}
...
\hypertarget{excercise-2.-the-rise-of-the-arabic-book.-where-did-the-early-authors-of-arabic-books-come-from}{%
\section*{Excercise 2. ``The Rise of the Arabic Book''. Where did the early authors of Arabic books come from?}\label{excercise-2.-the-rise-of-the-arabic-book.-where-did-the-early-authors-of-arabic-books-come-from}}
\addcontentsline{toc}{section}{Excercise 2. ``The Rise of the Arabic Book''. Where did the early authors of Arabic books come from?}
...
\addcontentsline{toc}{subsection}{Studies}
...
\addcontentsline{toc}{subsection}{Additional online resources:}
